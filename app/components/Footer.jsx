  ...
  return (
    <footer className="relative bg-black text-white overflow-hidden border-t border-white/10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6 text-justify">
                An IT & digital marketing studio building bold brands, high-converting websites, and growth campaigns that actually move the needle. for safety, visibility, and dependable performance across critical environments.
              </p>
      ...
      <button
        ...
        className="fixed bottom-12 right-6 w-11 h-11 flex items-center justify-center rounded-xl bg-[#e21d23] hover:bg-red-700 shadow-lg transition"
      >
