      ...
      <div className="relative z-10 mx-auto max-w-[1500px] px-6 lg:px-10">
        ...
        >
          ...
          <h2 className="mt-5 text-4xl font-medium leading-tight text-gray-900 md:text-4xl">
            ...
            <span className="text-[#e21d23]"> Drive Growth</span>
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-gray-600">
            From custom web and app development to SEO, paid advertising, and
            branding — we deliver end-to-end digital solutions that help
